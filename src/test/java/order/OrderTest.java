...
public class OrderTest {
  ...
  @Test
  @DisplayName("Создание заказа без авторизации") // работает
  @Description("Метод получает данные об ингредиентах,создаёт заказ с помощью id ингредиентов без авторизации .В случае успешного выполнения запроса будет получен ответ со статусом 400.")
